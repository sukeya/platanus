...
#ifndef PLATANUS_BTREE_CONTAINER_H_
#define PLATANUS_BTREE_CONTAINER_H_
...
class btree_container {
 ...
 public:
  ...
  static constexpr std::size_t sizeof_leaf_node() { return Tree::sizeof_leaf_node(); }

  static constexpr std::size_t sizeof_internal_node() { return Tree::sizeof_internal_node(); }
...
#endif  // PLATANUS_BTREE_CONTAINER_H_
